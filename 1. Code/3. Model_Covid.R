...
ggsave(plot_grid(mapsmooth, Temp_smooth, rel_heights = c(0.9, 0.1)), file="3. Model/SmoothEstimate.pdf", width=14, height=5)
...
ggsave(Exit_rates, file="3. Model/ExitRate.pdf", width=7, height=4)
...
ggsave(est_vs_true_plot, file="3. Model/RKIvsEst.pdf", height=10, width=10)
...
ggsave(LogLike, file="3. Model/LogLikeCov.pdf", height=3, width=5)
