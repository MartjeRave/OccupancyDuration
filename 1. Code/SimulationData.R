...
ggsave(Exit_rates, file="exitrateBias.pdf", width =5, height=3 )
...
ggsave(Est_True, file="InOutEst.pdf",
       width=8, height=4)
...
ggsave(Exit_rates_gt, file="ExitRateGroundTruth.pdf",
       width=5, height=3)
ggsave(Exit_rates, file="ExitRateEst.pdf",
       width=5, height=3)
...
ggsave(LogLike, file="C:/Users/ra98jiq/Downloads/LogLikeSim.pdf", height=3, width=5)
